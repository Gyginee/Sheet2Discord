...
declare class Sync {
    ...
    import(id: string): Promise<ImportedModule>;
    import(id: Array<string>): Promise<Array<ImportedModule>>;
    import(id: Array<string>, _from: string): Promise<Array<ImportedModule>>;
    import(id: string, _from: string): Promise<ImportedModule>;
